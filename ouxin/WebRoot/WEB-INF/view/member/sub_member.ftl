...
<html class="no-js">
<head>
	<title>我的 ${("1"==layer)?string('合伙人', ("2"==layer)?string('代理商', ("3"==layer)?string('业务员', '--')))}</title>
	<meta charset="utf-8">
...
<body>
	<header class="header_white">
		...
		<div class="header_title">${("1"==layer)?string('我的合伙人', ("2"==layer)?string('我的代理商', ("3"==layer)?string('我的业务员', '--')))}</div>
	</header>
	<div class="">
