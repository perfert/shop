...
<@mngTpl>	
	...
	<body class="no-skin">
		<@container>
			<@breadcrumbs items="评论列表" />			
			<@content>
				<@dataTable pager=pager prefix="${ctxPath}/manage/news/${article}/comment/"; pager, prefix>
					<div class="row">
						<div class="col-sm-8" style="width:auto;">
							<div class="dataTables_filter">
								<label>评论账号：<input type="text" name="query.account" value="${query.account}" aria-controls="sample-table-2" /></label>
					...
					<@thead>
						...
						<th class="sorting_disabled" style="width:35%;">内容</th>
