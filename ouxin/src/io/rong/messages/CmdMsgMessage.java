...
public class CmdMsgMessage extends BaseMessage {
    ...
    public static final String CMD_MESSAGE_TYPE = "apply";
    public static final String CMD_MESSAGE_WALLET_TYPE = "wallet";
    
    public static final String CONTACT_OPERATION_REQUEST = "Request";
    public static final String CONTACT_OPERATION_ACCEPT_RESPONSE = "Accept";
    public static final String CONTACT_OPERATION_REJECT_RESPONSE = "Reject";
    public static final String CONTACT_OPERATION_DELETE_RESPONSE = "Delete";
