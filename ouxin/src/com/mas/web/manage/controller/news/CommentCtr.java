...
import com.mas.web.manage.controller.dto.news.CommentCtrDto;
 ...
 */
@Controller
@RequestMapping( CommentCtr.URI_PREFIX )
public class CommentCtr extends ManageCtr<Comment, CommentCtrDto>
{
	public static final String URI_PREFIX = "manage/news/{article}/comment";
	 ...
	 */
	@Override
	public String page(@PathVariable int pageNo, CommentCtrDto dto, HttpServletRequest request, ModelMap model, @PathVariable Map<String, Object> params)
	{
		try {
	...
	@Override
	public String edit(@PathVariable String id, CommentCtrDto dto, ModelMap model, @PathVariable Map<String, Object> params)
	{
		try {
	 ...
	 */
	@Override
	public String create(CommentCtrDto dto, HttpServletRequest request, RedirectAttributes model, @PathVariable Map<String, Object> params)
	{
		try {
	 ...
	 */
	@Override
	public String modify(CommentCtrDto dto, HttpServletRequest request, RedirectAttributes model, @PathVariable Map<String, Object> params)
	{
	...
	@Override
	protected BaseService<Comment> service()
	{
		return service;
	}
	...
	private static final Logger log = LogManager.getLogger( CommentCtr.class );
}