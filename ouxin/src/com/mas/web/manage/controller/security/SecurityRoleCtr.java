...
import com.mas.web.manage.controller.dto.security.SecurityRoleCtrDto;
 ...
 */
@Controller
@RequestMapping( SecurityRoleCtr.URI_PREFIX )
public class SecurityRoleCtr extends ManageCtr<SecurityRole, SecurityRoleCtrDto>
{
	public static final String URI_PREFIX = "manage/security/{systemModuleId}/role";
	 ...
	 */
	@Override
	public String page(@PathVariable int pageNo, SecurityRoleCtrDto dto, HttpServletRequest request, ModelMap model, @PathVariable Map<String, Object> params)
	{
		try {
			if( null == dto.getQuery() )
			{
				SecurityRole query = new SecurityRole();
				query.setSystemModuleId( pathValue( params, "systemModuleId" ) );
				dto.setQuery( query );
			}
	...
	@Override
	public String edit(@PathVariable String id, SecurityRoleCtrDto dto, ModelMap model, @PathVariable Map<String, Object> params)
	{
		try {
	 ...
	 */
	@Override
	public String create(SecurityRoleCtrDto dto, HttpServletRequest request, RedirectAttributes model, @PathVariable Map<String, Object> params)
	{
		try {
	 ...
	 */
	@Override
	public String modify(SecurityRoleCtrDto dto, HttpServletRequest request, RedirectAttributes model, @PathVariable Map<String, Object> params)
	{
	...
	@Override
	protected BaseService<SecurityRole> service()
	{
		return service;
	}
	...
	{
		return "manage/security/role";
	}
	
	@Override
	protected String REDIRECT_VIEW_PREFIX( Map<String, Object> params ) 
	{
		return "manage/security/" + pathValue( params, "systemModuleId" ) + "/role";
	}
	...
	private static final Logger log = LogManager.getLogger( SecurityRoleCtr.class );
}