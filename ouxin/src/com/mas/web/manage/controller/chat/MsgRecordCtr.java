...
import com.mas.web.manage.controller.dto.chat.MsgRecordCtrDto;
 ...
 */
@Controller
@RequestMapping( MsgRecordCtr.URI_PREFIX )
public class MsgRecordCtr extends ManageCtr<MsgRecord, MsgRecordCtrDto>
{
	public static final String URI_PREFIX = "manage/chat/record";
	 ...
	 */
	@Override
	public String page(@PathVariable int pageNo, MsgRecordCtrDto dto, HttpServletRequest request, ModelMap model, @PathVariable Map<String, Object> params)
	{
		try {
			if( null == dto.getQuery() ){
			    MsgRecord query = new MsgRecord();
				dto.setQuery( query );
			}
	...
	@Override
	public String edit(@PathVariable String id, MsgRecordCtrDto dto, ModelMap model, @PathVariable Map<String, Object> params)
	{
		try {
	 ...
	 */
	@Override
	public String create(MsgRecordCtrDto dto, HttpServletRequest request, RedirectAttributes model, @PathVariable Map<String, Object> params)
	{
		try {
	 ...
	 */
	@Override
	public String modify(MsgRecordCtrDto dto, HttpServletRequest request, RedirectAttributes model, @PathVariable Map<String, Object> params)
	{
	...
	@Override
	protected BaseService<MsgRecord> service()
	{
		return service;
	}
	...
	@Autowired
	private MsgRecordService service;
	
	private static final Logger log = LogManager.getLogger( MsgRecordCtr.class );
}