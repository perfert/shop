 ...
 */
@Controller
@RequestMapping( FriendsCtr.URI_PREFIX )
public class FriendsCtr extends ManageCtr<Friends, FriendsCtrDto>
{
	public static final String URI_PREFIX = "manage/chat/{id}/friends";
	...
	private static final Logger log = LogManager.getLogger( FriendsCtr.class );
