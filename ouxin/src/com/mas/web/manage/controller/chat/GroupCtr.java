...
import com.mas.web.manage.controller.dto.chat.GroupCtrDto;
 ...
 */
@Controller
@RequestMapping( GroupCtr.URI_PREFIX )
public class GroupCtr extends ManageCtr<Group, GroupCtrDto>
{
	public static final String URI_PREFIX = "manage/chat/group";
	 ...
	 */
	@Override
	public String page(@PathVariable int pageNo, GroupCtrDto dto, HttpServletRequest request, ModelMap model, @PathVariable Map<String, Object> params)
	{
		try {
	...
	@Override
	public String edit(@PathVariable String id, GroupCtrDto dto, ModelMap model, @PathVariable Map<String, Object> params)
	{
		try {
	 ...
	 */
	@Override
	public String create(GroupCtrDto dto, HttpServletRequest request, RedirectAttributes model, @PathVariable Map<String, Object> params)
	{
		try {
	 ...
	 */
	@Override
	public String modify(GroupCtrDto dto, HttpServletRequest request, RedirectAttributes model, @PathVariable Map<String, Object> params)
	{
	...
	@Override
	protected BaseService<Group> service()
	{
		return service;
	}
	...
	private static final Logger log = LogManager.getLogger( GroupCtr.class );
}