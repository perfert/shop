 ...
 */
@Controller
@RequestMapping(WealthTypeCtr.URI_PREFIX)
public class WealthTypeCtr extends ManageCtr<WealthType, WealthTypeDto> {

    public static final String URI_PREFIX = "manage/wallet/wealth_type";
    
    @Override
    public String edit(@PathVariable String id, WealthTypeDto dto, ModelMap model, @PathVariable Map<String, Object> params)
    {
        try {
     ...
     */
    @Override
    public String create(WealthTypeDto dto, HttpServletRequest request, RedirectAttributes model, @PathVariable Map<String, Object> params)
    {
        try {
     ...
     */
    @Override
    public String modify(WealthTypeDto dto, HttpServletRequest request, RedirectAttributes model, @PathVariable Map<String, Object> params)
    {
    ...
    @Override
    protected BaseService<WealthType> service() {
        return service;
    }
    ...
    @Autowired
    private WealthTypeService service;

    private static final Logger log = LogManager.getLogger(WealthTypeCtr.class);
}